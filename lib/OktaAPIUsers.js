 ...
 * @param callback
 */
OktaAPIUsers.prototype.delete = function(id, callback) {
    if(id == undefined) throw new Error("A user ID is required when deleting a user");
    this.request.delete("users/" + id, null, callback);
}
